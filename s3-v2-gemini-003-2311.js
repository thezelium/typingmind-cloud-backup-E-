...
function importDataToStorage(data) {
  return new Promise((resolve, reject) => {
    ...
    // Funzione per convertire Array/Buffer in Blob
            ...
            if (!preserveKeys.includes(key)) {
              try {
                ...
                if (typeof valueToStore === "string" && (valueToStore.startsWith("{") || valueToStore.startsWith("["))) {
                  ...
                  } catch (e) { /* Era solo una stringa */ }
                }

                // Tentativo di "Reviving" del file binario
                ...
                if (revived instanceof Blob) {
                    ...
                    if (filesRestored <= 5) {
                        logToConsole("info", `Restored potential file for key: ${key}`, { size: valueToStore.size });
                    }
                }
